...
public class ToggleButton extends JComponent {
    ...
    private void init() {
        ...
        setPreferredSize(new Dimension(jCheckBox.getPreferredSize().width*2, (int) (jCheckBox.getPreferredSize().height*1.2)));
        setBackground(jCheckBox.getBackground());
        setForeground(jCheckBox.getForeground());
